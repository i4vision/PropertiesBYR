...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72-3.72a2.25 2.25 0 0 0-3.182 0l-3.72 3.72a2.25 2.25 0 0 1-3.182 0l-3.72-3.72A2.25 2.25 0 0 1 3.75 15V10.608c0-.97.616-1.813 1.5-2.097m15 0c.256-.083.514-.15.774-.216a2.25 2.25 0 0 0-2.32-.216m-15 0a2.25 2.25 0 0 0-2.32.216c.26-.066.518-.133.774-.216m15 0c-.22.578-.496 1.126-.812 1.64m-13.376 0c-.316-.514-.592-1.062-.812-1.64m12.552 0c.621 1.168 1 2.505 1 3.892v.333a2.25 2.25 0 0 1-2.25 2.25H6.75a2.25 2.25 0 0 1-2.25-2.25v-.333c0-1.387.379-2.724 1-3.892m12.552 0c-.621-1.168-1-2.505-1-3.892a2.25 2.25 0 0 0-2.25-2.25H7.5A2.25 2.25 0 0 0 5.25 8.11c0 1.387.379 2.724 1 3.892" />
  </svg>
);
